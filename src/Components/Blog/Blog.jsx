   ...
   return (
        <div >
           <div className="card w-80 bg-base-100 shadow-2xl rounded-3xl my-8">
                 ...
                 <h2 className="card-title text-black-950 text-xl font-medium my-2">{title}</h2>
                 <p>{details}</p>
                 
                  <div className='flex justify-between my-4'>
                 <div className='flex text-xl font-medium'>
                    <h1><FaDollarSign className='text-natural-500 my-1'></FaDollarSign></h1>
                    <h2 >Price:{price}</h2>
                </div>
                
                <div className='font-medium'>
                    <div className='flex text-xl'>
                        <h1><FaBookOpen className='text-natural-500 my-1'></FaBookOpen></h1>
